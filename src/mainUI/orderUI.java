	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("placeOrder")) {
			...
			if (result == JOptionPane.OK_OPTION) {
				placeOrder(drugToOrder.getText(), "m", Integer.parseInt(numOfDrug.getText()), Integer.parseInt(numOfContainer.getText()), dosageOfDrug.getText());
				JOptionPane.showMessageDialog(orderPanel, "Order Placed.");
			}
		}
